      ...
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <?php //if($this->rbac->check_operation_permission('add')): ?>
            <a href="<?php echo base_url (); ?>main/customer_add" class="btn btn-success"> Add Customers <i class="fa fa-plus"></i> </a>
      ...
      <div class="card-body table-responsive">
        <table id="na_datatable" class="table table-bordered table-striped" width="50%">
          ...
          <?php// print_r($records); die();  ?>
           ...
           <a font-size:50%; title="View" class="view btn btn-sm btn-info" href="<?php echo base_url()?>main/customer_list"> <i class="fa fa-eye"></i></a >
            <a title="Edit" class="update btn btn-sm btn-warning"  href="<?php echo base_url()?>main/customer_edit/<?php echo  "{$rec['id']}"; ?>"> <i class="fa fa-edit"></i></a>
