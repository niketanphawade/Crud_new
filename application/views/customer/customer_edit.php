      ...
      <div class="card card-default">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?php echo base_url (); ?>main/customer_list" class="btn btn-success"><i class="fa fa-list"></i>  Customer List</a>
          </div>
        </div>
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <form method="post" id="submit" action="<?php echo base_url() ?>main/customer_edit">
            <?php  
