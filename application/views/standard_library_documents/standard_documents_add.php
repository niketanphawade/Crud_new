      ...
      <div class="card card-default">
        <div class="card-header">
          <div class="d-inline-block">
              <h3 class="card-title"> <i class="fa fa-plus"></i> Add Standard Library Documents</h3>
          </div>
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <form method="post" id="submit" enctype="multipart/form-data" action="<?php echo base_url() ?>parts/standard_documents_add">
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input type="text" name="document_name" class="form-control" id="document_name" placeholder="">
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <input type="file" name="Name" class="form-control" id="Name" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input type="text" name="revision_number" class="form-control" id="revision_number" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input type="text" name="revision_remark" class="form-control" id="revision_remark" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="Name" class="col-md-2 control-label"> Revision Date</label>
                <div class="col-md-6">
                  <input type="date" name="revision_date" class="form-control" id="revision_date" placeholder="">
                </div>
              </div>
